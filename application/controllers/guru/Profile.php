...
class Profile extends CI_Controller
{
    ...
    public function index()
    {
        $data = [
            ...
            'user' => $this->Model_guru_profile->findUser(['email' => $this->session->userdata('email')])
        ];

        $this->load->view('backend/templates/header', $data);
        $this->load->view('backend/templates/sidebar_guru', $data);
        $this->load->view('backend/templates/topbar', $data);
        $this->load->view('backend/guru/profile_index', $data);
    ...
    public function edit_profile()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('backend/templates/sidebar_guru', $data);
            $this->load->view('backend/templates/topbar', $data);
            $this->load->view('backend/guru/profile_edit', $data);
            $this->load->view('backend/templates/footer', $data);
        } else {
            ...
            if ($this->input->post('check_default_image') == 'true') {
                ...
                $this->Model_guru_profile->editDataProfile($email, $dataEdit);
    ...
    public function ubah_email()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $user = $this->Model_guru_profile->findUser(['email' => $this->session->userdata('email')]);
            $this->Model_guru_profile->ubahEmail($user['email'], ['email' => $emailBaru, 'updated_at' => date('Y-m-d H:i:s')]);
    ...
    public function ubah_password()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('backend/templates/sidebar_guru', $data);
            $this->load->view('backend/templates/topbar', $data);
            $this->load->view('backend/guru/profile_ubah_password', $data);
            $this->load->view('backend/templates/footer', $data);
        } else {
            $email = ['email' => $data['user']['email']];
            ...
            if (password_verify($password_saat_ini, $data['user']['password'])) {
                ...
                $this->Model_guru_profile->ubahPassword($email, $passwordBaru);
            ...
            redirect(base_url('guru/profile/ubah_password'));
        }
    }
}
