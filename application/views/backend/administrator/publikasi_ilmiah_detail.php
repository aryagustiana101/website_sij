<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url('administrator/publikasi_ilmiah'); ?>">Publikasi Ilmiah</a></li>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <dl class="row px-4">
                        ...
                        <dt class="col-sm-3">Level Publikasi Ilmiah</dt>
                        <dd class="col-sm-9"><?= $publikasiIlmiah['level_penulis']; ?></dd>
                        <dt class="col-sm-3">Email Pengguna Publikasi</dt>
                        <dd class="col-sm-9"><?= $publikasiIlmiah['email_user']; ?></dd>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Baca Publikasi Ilmiah</h6>
                </div>
                <div class="card-body">
