    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <?= form_open_multipart(base_url('administrator/berita/edit_berita/') . $berita['id']); ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="penulis" name="penulis" value="<?= $berita['penulis']; ?>">
                            <?= form_error('penulis', '<small class="text-danger">', '</small>'); ?>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="gambar" class="col-sm-4 col-form-label font-weight-bold">Gambar Thumbnail Berita</label>
                        <div class="col-sm-8">
                            <div class="row">
                                <div class="col-sm-3">
                                    ...
                                    <?php else : ?>
                                        <img src="<?= base_url(); ?>./uploads/berita/<?= $berita['gambar']; ?>" class="img-thumbnail" id="img">
                                    <?php endif; ?>
                                </div>
                                <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="summernote" name="isi_berita"><?= $berita['isi_berita']; ?></textarea>
                    </div>
