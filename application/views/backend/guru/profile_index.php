        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <a href="<?= base_url('guru/profile/edit_profile'); ?>" class="btn btn-sm btn-primary mr-3"><i class="fas fa-pencil-alt mr-1"></i> Edit Profile</a>
                    ...
                    <a href="<?= base_url('guru/profile/ubah_password'); ?>" class="btn btn-sm btn-primary"><i class="fas fa-key mr-1"></i> Ubah Password</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="ubahEmailModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?= form_open_multipart('guru/profile/ubah_email') ?>
