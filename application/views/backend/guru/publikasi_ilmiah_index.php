        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Tabel Publikasi Ilmiah Yang Anda Publikasikan</h6>
                </div>
                <div class="card-body">
                    <div class="row pl-2">
                            ...
                            <tbody>
                                ...
                                foreach ($publikasiIlmiahAll as $publikasiIlmiah) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('guru/publikasi_ilmiah/detail_publikasi_ilmiah/') . $publikasiIlmiah['id']; ?>" class=" btn btn-sm btn-success mb-2"><i class="fas fa-fw fa-search-plus"></i></a>
...
<div class="modal fade" id="modalTambahPublikasiIlmiah" tabindex="-1" role="dialog" aria-labelledby="modalTambahPublikasiIlmiah" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?= form_open_multipart('guru/publikasi_ilmiah/tambah_publikasi_ilmiah'); ?>
    ...
    <div class="modal fade" id="modalEditPublikasiIlmiah<?= $publikasiIlmiah['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="modalEditPublikasiIlmiah" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <?= form_open_multipart('guru/publikasi_ilmiah/edit_publikasi_ilmiah') ?>
    ...
    <div class="modal fade" id="modalHapusPublikasiIlmiah<?= $publikasiIlmiah['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="modalHapusPublikasiIlmiah" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <?= form_open('guru/publikasi_ilmiah/hapus_publikasi_ilmiah') ?>
                <input type="hidden" name="id" value="<?= $publikasiIlmiah['id']; ?>">
                <input type="hidden" name="file_publikasi_ilmiah" value="<?= $publikasiIlmiah['file_publikasi_ilmiah']; ?>">
                <div class="modal-body">
                    Apakah Anda Yakin Untuk Menghapus Publikasi Ilmiah <b><?= $publikasiIlmiah['judul']; ?> </b>Yang Anda Diterbitkan Pada <b><?= date("d F Y H:i:s", strtotime($publikasiIlmiah['created_at'])); ?></b>?
                </div>
                <div class="modal-footer">
                    <button class="btn btn-sm btn-secondary" type="button" data-dismiss="modal">Batal</button>
